...
| **8** | [**Context, Pipeline & Expert Parallelism**](08-context-pipeline.md) | Analytical 5D cluster sizing, memory estimation, 1F1B bubble calculations, and EP All-to-All | `nanolm/parallelism_calc.py`<br>`scripts/08_parallelism_sizing.py` | Defense of outer-to-inner hierarchy (PP->DP->FSDP->EP->TP) |
